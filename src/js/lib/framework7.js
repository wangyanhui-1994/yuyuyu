 ...
 */
    ...
    var Framework7 = function (params){
        ...
        ************   Smart Select   ************
        ...
        app.smartSelectOpen = function (smartSelect, reLayout){
            ...
            var useSearchbar = typeof smartSelect.data('searchbar') === 'undefined' ? app.params.smartSelectSearchbar : (smartSelect.data('searchbar') === 'true');
        ...
        var PhotoBrowser = function (params){
            ...
            pb.layout = function (index){
                ...
                var sliderSettings = {
                    ...
                    preloadImages: !pb.params.lazyLoading,
        ...
        ************   Calendar   ************
        ...
        var Calendar = function (params){
            ...
            p.nextMonth = function (transition){
                ...
                var transitionEndCallback = !p.animating;
                if (p.params.maxDate){
    ...
    window.Swiper = function (container, params){
        ...
        s.initEvents = function (detach){
            ...
            var moveCapture = !!s.params.nested;
